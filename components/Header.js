    ...
    <header className=" sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md  p-5 md:px-10 ">
      ...
      <div className="flex flex-col col-span-3 mx-auto my-4">
        ...
        <div className="flex  items-center border-b mb-4">
          <h2 className="text-2xl flex-grow font-semibold ">Number of Geusts</h2>

          <UsersIcon className="h-5"/>
          <input min={1} value={numOfGuests} onChange={ e=>setNumOfGuests(e.target.value)}type="number" className="w-12 pl-2 text-base outline-none text-red-400" />
        </div>
        <div className="flex  ">
